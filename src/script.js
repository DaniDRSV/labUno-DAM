...
class Calculadora {
    ...
    constructor(valorPrevioTextElement, valorActualTextElement) {
        ...
        this.borrarTodo()
        //inicializa la calculadora con isEqual en false
        this.isEqual = false
    }
    ...
    borrarTodo() {
        ...
        this.valorPrevioTextElement.innerText = '' // Se limpia el texto del valor previo
    }
    ...
    agregarNumero(numero) {
        // Si se obtuvo un resultado previo, borra todo e inicia una nueva operacion
        if (this.isEqual) {
            this.borrarTodo();
            this.isEqual = false;
        }
    ...
    elejirOperacion(operacion) {
        ...
        // Si no hay valor actual, no hacer nada
        ...
        this.valorActual = ''
        // Marca que es una nueva operacion y no un resultado
        this.isEqual = false
    }
    ...
    calcular() {
        ...
        // Guarda el operador antes de resetearlo
        const operacionGuardada = this.operacion
        // Actualiza la pantalla superior (valor previo) con la ecuación completa
        this.valorPrevioTextElement.innerText = `${this.obtenerNumero(valor_1)} ${operacionGuardada} ${this.obtenerNumero(valor_2)} =`
    ...
    calcularPorcentaje() {
        ...
        switch (this.operacion) {
            case '+':
                resultado = valor_1 + (valor_1 * valor_2) / 100
                break
            case '-':
                resultado = valor_1 - (valor_1 * valor_2) / 100
                break
...
// Ejecuta el cálculo de la operación de porcentaje
...
/*Laboratorio:
1. Arreglar bug que limite los numeros en pantalla *** LISTOO ***
2. Funcionabilidad de boton de porcentaje *** LISTOO ***
3. Si lo que se presiona despues de igual es un numero entonces que borre el resultado anterior e inicie una nueva operacion *** LISTOO ***
4. Muestre la operacion completa en el display superior *** LISTOO ***
*/